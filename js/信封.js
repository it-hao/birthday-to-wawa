...
heart.addEventListener('click', function () {
    ...
    setTimeout(() => {
        ...
        // let str = '亲爱的孔哇哇：<'+
        // '展信颜舒，见字如晤！<'+
        // '时光荏苒，岁月如梭，转眼间我们已经认识120余天了。<'+
        // '在这期间，我们有过短暂的分离，感谢你重新给我追求你的机会。<'+
        // '在今天这个特别的日子里，我想借此机会，向你表达我最真挚的祝福。<'+
        // '回想一起度过的短暂时光，每个瞬间都如同珍贵的宝石，闪耀着温暖的光芒。<'+
        // '在未来的日子里，希望我们能够携手前行，共同迎接生活中的挑战与美好。<'+
        // '^2026年5月9日<'+
        // '^沈哇哇';
        let str = '亲爱的孔哇哇：<'+
        '展信安悦，见字如晤。<'+
        '时光悄然流转，岁月温柔前行，不知不觉，我们已相伴一百二十余天。<'+
        '一路走来，有过短暂分离，很庆幸，你愿意再给我一次奔赴与喜欢你的机会。<'+
        '在这个温柔又特别的日子里，我想借着一纸心意，赠予你满心赤诚的祝福。<'+
        '回望相伴的点滴瞬间，每一段过往，都如星光般珍贵，在心底熠熠生辉。<'+
        '往后漫漫岁月，愿我们携手并肩，共赴烟火日常，一同接纳风雨，共享人间温柔与美好。<'+
        '^2026年5月9日<'+
        '^沈哇哇';
        //let strp = '<p>'
...
function showBonusButton() {
    ...
    btn.addEventListener('click', function() {
        ...
        // window.location.href = '../html/彩蛋原版.html?audioTime='+ currentTime; 
    });
